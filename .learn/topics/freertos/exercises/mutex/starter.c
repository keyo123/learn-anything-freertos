...
static void vTaskLowPriority(void *pvParameters)
{
    ...
    if (xSemaphoreTake(xMutexPri, portMAX_DELAY) == pdTRUE)
    {
        ...
        // UART_Printf("Low task took mutex, priority: %d\r\n",
        ...
        // UART_Printf("Low task giving mutex, priority: %d\r\n",
        //              uxTaskPriorityGet(NULL));
...
static void vTaskHighPriority(void *pvParameters)
{
    ...
    {
        /* TODO: 打印成功获取互斥量 */
        // UART_Printf("High task got mutex\r\n");
    ...
    {
        /* TODO: 打印超时未能获取 */
        // UART_Printf("High task TIMEOUT - mutex not available\r\n");
    }
