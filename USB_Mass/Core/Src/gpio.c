...
void MX_GPIO_Init(void)
{
  ...
  /* Configure USB_ENABLE: start with D+ pull-up DISABLED (HIGH).
     Will be enabled (LOW) in main() AFTER MX_USB_DEVICE_Init(). */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LCD_RES_Pin|LCD_DC_Pin|WQ25_CS_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LCD_RES_Pin LCD_DC_Pin WQ25_CS_Pin LED1_Pin
                           LED2_Pin */
  GPIO_InitStruct.Pin = LCD_RES_Pin|LCD_DC_Pin|WQ25_CS_Pin|LED1_Pin
                          |LED2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
